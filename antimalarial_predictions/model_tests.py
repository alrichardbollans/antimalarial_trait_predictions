...
def biased_case():
    ...
    ### Models
    xgb_scores = clf_scores('XGB', XGBClassifier, use_missing_vals=True, grid_search_param_grid={
        'max_depth': [3, 6, 9]
    ...
    for i in range(2):
        ...
        for train_index, test_index in kf.split(X, y):
            ...
            imputed_X_train, imputed_X_test, imputed_unlabelled, cols_with_good_variance = \
                do_basic_preprocessing(X, y,
                                       ...
                                       impute=True,
                                       scale=True)
            unimputed_X_train, unimputed_X_test, unimputed_unlabelled, cols_with_good_variance_two = \
                do_basic_preprocessing(X, y,
                                       train_index,
                                       test_index,
                                       unlab_X,
            ...
            for model in models:
                ...
                elif model.use_missing_vals:
                    model.add_cv_scores(unimputed_X_train, y_train, unimputed_X_test, y_test)
                else:
...
def in_the_wild_test():
    ...
    models = [xgb_scores, logit_scores, svc_scores,
              ...
              general_ethnobotanical_scores]
    all_weights = \
        logit_correction(labelled_data, ALL_TRAITS_IN_ALL_REGIONS,
